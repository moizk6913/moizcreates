...
export default function ClientsStrip() {
  return (
    <section id="visual-references" className="w-full pt-16 sm:pt-24 md:pt-32 pb-24 sm:pb-36 md:pb-48 bg-canvas overflow-hidden border-none relative select-none">
