        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 xl:gap-10 items-stretch">
          {PHASES.map((phase, idx) => (
            <div
              ...
              className="rounded-[28px] sm:rounded-[34px] bg-[#faf9f6] p-7 sm:p-9 md:p-10 border border-neutral-200/70 flex flex-col justify-between space-y-8 hover:shadow-[0_16px_40px_rgba(0,0,0,0.05)] hover:-translate-y-1.5 transition-all duration-500 group"
            >
