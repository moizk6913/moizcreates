...
export default function About() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="w-full py-24 sm:py-32 md:py-40 bg-gradient-to-b from-canvas via-[#faf9f6] to-[#f4f2ee] relative overflow-hidden flex items-center justify-center text-center select-none"
    >
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 flex flex-col items-center justify-center text-center">
        <h2 className="font-display font-black text-2xl sm:text-4xl md:text-5xl lg:text-6xl uppercase tracking-tight leading-[1.12] text-primary flex flex-col items-center justify-center gap-1 sm:gap-2">
          ...
          <span className="overflow-hidden block py-0.5">
            <span className="statement-line block will-change-transform">
              GOOD. <Link href="/about" className="text-black underline underline-offset-4 hover:text-neutral-500 cursor-pointer transition-colors">LET&apos;S TALK.</Link>
            </span>
          </span>
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/about"
            className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-[10px] bg-primary text-canvas hover:bg-neutral-800 transition-all duration-300 font-mono text-xs uppercase tracking-widest hover:scale-105 shadow-sm"
          >
